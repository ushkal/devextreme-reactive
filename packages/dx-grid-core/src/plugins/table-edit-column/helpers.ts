...
type IsEditCommandsCellFn = (tableRow: TableRow, tableColumn: TableColumn) => boolean;

export const isHeadingEditCommandsTableCell: IsEditCommandsCellFn = (
  tableRow, tableColumn,
) => tableRow.type === TABLE_HEADING_TYPE && tableColumn.type === TABLE_EDIT_COMMAND_TYPE;
export const isEditCommandsTableCell: IsEditCommandsCellFn = (
  tableRow, tableColumn,
