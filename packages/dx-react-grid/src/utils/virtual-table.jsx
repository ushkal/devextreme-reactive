...
console.log(rowsWithChangedHeights)
    ...
    updateRowHeightsFromProps(nextProps, prevState) {
      ...
      const rowHeights = [...nextProps.headerRows, ...nextProps.bodyRows, ...nextProps.footerRows]
        ...
        console.log(rowHeights, this.state.rowHeights)
      return { rowHeights };
    }
    ...
    render() {
      ...
      const visibleBoundariesComputed = ({
        ...
        const getRowsBoundary = (top, partHeight) => (
          getRowsVisibleBoundary(rows, top, partHeight, this.getRowHeight)
        );

        return {
          columns: getColumnsVisibleBoundary(columns, viewportLeft, width, getColumnWidth),
          headerRows: getRowsBoundary(0, headerHeight),
          bodyRows: getRowsBoundary(viewportTop, height - headerHeight - footerHeight),
          footerRows: getRowsBoundary(0, footerHeight),
        };
      };
      ...
      return (
        <Plugin name="VirtualTable">
          ...
          <Template name="tableLayout">
            {(params) => {
              // this.updateRowHeightsFromProps(params, this.state)
